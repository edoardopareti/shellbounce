...
export const TANK_REVERSE_SPEED = 105; // The backward movement speed of the tank in pixels per second
...
export const CHARGED_SHOT_OVERCHARGE_MS = 2200;  // The time after which a charged shot overcharges
export const CHARGED_SHOT_COOLDOWN_MS = 2500;  // The cooldown time after firing a charged shot before it can be fired again
...
export const TANK_RESPAWN_DELAY_MS = 1400; // The delay before a tank respawns after being destroyed, in milliseconds
